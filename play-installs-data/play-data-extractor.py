...
bucket_name = 'pubsite_prod_rev_04037181267653010766'
path = 'stats/installs/'
target_bucket_name = 'arched-glass-136921.appspot.com'
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "./google-service-cred.json"
